...
for i in range(FLAGS.num_experiments):
    ...
    gae_model = GCNModelAE(placeholders, num_features, features_nonzero, False, FLAGS.bilinear)
    # Optimizer
    with tf.name_scope('optimizer'):
        opt = OptimizerAE(preds=gae_model.reconstructions,
    ...
    with sess.as_default():
        ...
        def get_roc_score(edges_pos, edges_neg, emb=None):
            if emb is None:
                ...
                emb = sess.run(gae_model.z_mean, feed_dict=feed_dict)
